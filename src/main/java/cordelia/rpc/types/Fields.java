...
public final class Fields {
    ...
    public static final String DOWNLOADED_EVER = "downloadedEver";
    ...
    public static final String ETA_IDLE = "etaIdle";
    ...
    public static final String MANUAL_ANNOUNCE_TIME = "manualAnnounceTime";
    public static final String MAX_CONNECTED_PEERS = "maxConnectedPeers";
    ...
    public static final String PEERS_FROM = "peersFrom";
    ...
    public static final String PRIMARY_MIME_TYPE = "primary-mime-type";
    ...
    public static final String SEQUENTIAL_DOWNLOAD = "sequentialDownload";
    public static final String SIZE_WHEN_DONE = "sizeWhenDone";
    public static final String START_DATE = "startDate";
    public static final String STATUS = "status";
    public static final String TRACKERS = "trackers";
    public static final String TRACKER_LIST = "trackerList";
