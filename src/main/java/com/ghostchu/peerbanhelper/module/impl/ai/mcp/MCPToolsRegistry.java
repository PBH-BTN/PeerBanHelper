...
public class MCPToolsRegistry {
     ...
     * @param handler 工具处理器
     */
    public void registerTool(String name, String description, Function<Map<String, Object>, Map<String, Object>> handler) {
        McpSchema.Tool tool = createTool(name, description);
