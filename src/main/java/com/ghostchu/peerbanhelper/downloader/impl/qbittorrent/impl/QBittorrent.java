...
public final class QBittorrent extends AbstractQbittorrent {
    ...
    public QBittorrent(String id, QBittorrentConfig config, AlertManager alertManager, HTTPUtil httpUtil) {
    ...
    public static QBittorrent loadFromConfig(String id, JsonObject section, AlertManager alertManager, HTTPUtil httpUtil) {
        QBittorrentConfigImpl config = JsonUtil.getGson().fromJson(section.toString(), QBittorrentConfigImpl.class);
        return new QBittorrent(id, config, alertManager, httpUtil);
    }

    public static QBittorrent loadFromConfig(String id, ConfigurationSection section, AlertManager alertManager, HTTPUtil httpUtil) {
