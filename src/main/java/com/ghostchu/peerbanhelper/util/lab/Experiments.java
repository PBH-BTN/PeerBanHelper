...
public enum Experiments {
    ...
    LAB_EXPERIMENT_ASYNC_BANLIST_APPLY(new Experiment("async_banlist_apply", List.of(0, 5), new TranslationComponent(Lang.LAB_EXPERIMENT_ASYNC_BANLIST_APPLY), new TranslationComponent(Lang.LAB_EXPERIMENT_ASYNC_BANLIST_APPLY_DESCRIPTION)))
    ;
