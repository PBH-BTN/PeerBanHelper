...
public enum Lang {
    ...
    BGTASK_TITLE_EMPTY,
    BGTASK_WEBSOCKET_TASK_NOT_FOUND, PORT_MAPPER_PORT_MAPPED_NEW, AUTOSTUN_DOWNLOADER_TUNNEL_TEST_FAILED, BTSTUN_ON_TUNNEL_CLOSE_WITH_REASON, AUTOSTUN_DOWNLOADER_TUNNEL_ERRORED;
