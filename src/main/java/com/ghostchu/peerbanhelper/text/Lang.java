...
public enum Lang {
    ...
    LAB_EXPERIMENT_ASYNC_IPDB_LOADING_DESCRIPTION, WATCH_DOG_HUNGRY_IN_DOWNLOADER_IO, DEMO_MODE_OPERATION_NOT_PERMITTED, MODULE_ANTI_VAMPIRE_TITLE, MODULE_ANTI_VAMPIRE_DESCRIPTION_XUNLEI_NON_0019, MODULE_ANTI_VAMPIRE_DESCRIPTION_XUNLEI_0019_SEEDING, DOWNLOADER_BC_FAILED_REQUEST_STATISTICS_LIST, DOWNLOADER_VERSION_INCOMPATIBLE, BTN_ABILITY_IP_DENYLIST_TITLE, BTN_ABILITY_IP_DENYLIST_DESCRIPTION, BTN_ABILITY_IP_DENYLIST_LOADED_FROM_CACHE, BTN_ABILITY_IP_DENYLIST_LOAD_FAILED_FROM_CACHE, BTN_ABILITY_IP_DENYLIST_LOADED_FROM_REMOTE_NO_CHANGES, BTN_ABILITY_IP_DENYLIST_LOADED_FROM_REMOTE, BTN_ABILITY_IP_ALLOWLIST_TITLE, BTN_ABILITY_IP_ALLOWLIST_DESCRIPTION, BTN_ABILITY_IP_ALLOWLIST_LOADED_FROM_CACHE, BTN_ABILITY_IP_ALLOWLIST_LOAD_FAILED_FROM_CACHE, BTN_ABILITY_IP_ALLOWLIST_LOADED_FROM_REMOTE_NO_CHANGES, BTN_ABILITY_IP_ALLOWLIST_LOADED_FROM_REMOTE, BTN_POW_CAPTCHA_LOAD_FROM_REMOTE, BTN_POW_CAPTCHA_COMPUTING, BTN_POW_CAPTCHA_COMPUTE_COMPLETED, BTN_ABILITY_IP_ALLOWLIST_HIT, BTN_ABILITY_IP_ALLOWLIST_RULE, BTN_ABILITY_IP_DENYLIST_RULE, BTN_ABILITY_IP_DENYLIST_HIT, BTN_ABILITY_IP_QUERY_TITLE, BTN_ABILITY_IP_QUERY_DESCRIPTION, BTN_ABILITY_IP_QUERY_STATUS_OK, BTN_ABILITY_IP_QUERY_NOT_PROVIDED, MALWARE_SCANNER_DETECTED, PEER_RECORDING_SERVICE_CLEANING_UP, PEER_RECORDING_SERVICE_CLEANED_UP, CONNECTION_METRICS_SERVICE_CLEANING_UP, CONNECTION_METRICS_SERVICE_CLEANED_UP, THREAD_UNCAUGHT_EXCEPTION, DBNT_MIGRATOR_MIGRATING_PROGRESS, DBNT_MIGRATOR_MIGRATING_COMPLETED, DBNT_MIGRATOR_LEGACY_UPGRADE_PROCESS, DBNT_MIGRATOR_STARTING, DBNT_MIGRATOR_COMPLETED, DBNT_MIGRATOR_FAILED, DBNT_MIGRATOR_CONNECTING_SQLITE, DBNT_MIGRATOR_MIGRATING_PREPARE, DBNT_MIGRATOR_MIGRATING_FINISHED, DBNT_LOADING_DRIVER, DBNT_LOADING_DRIVER_LOADED, DBNT_LOADING_MAPPER, DBNT_FLYWAY_VALIDATING_SCHEMA, DBNT_FLYWAY_ERROR;
