...
public enum Lang {
    ...
    DOWNLOADER_TRANSMISSION_BLOCKLIST_UPDATE_FAILED, GUI_TRAY_TITLE, CRASH_MANAGER_TITLE, CRASH_MANAGER_DESCRIPTION, CRASH_MANAGER_GUI_RELATED_TITLE, CRASH_MANAGER_GUI_RELATED_DESCRIPTION;
