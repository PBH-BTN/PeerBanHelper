...
public enum Lang {
    ...
    // PeerName Rule Subscription
    MODULE_PNB_MATCH_PEER_NAME_RULE,
    PEER_NAME_RULE_MATCH_ERROR,
    PEER_NAME_RULE_UPDATE_FINISH,
    PEER_NAME_RULE_NO_UPDATE,
    PEER_NAME_RULE_UPDATE_SUCCESS,
    PEER_NAME_RULE_UPDATE_FAILED,
    PEER_NAME_RULE_LOAD_SUCCESS,
    PEER_NAME_RULE_UPDATE_LOG_ERROR,
    PEER_NAME_RULE_USE_CACHE,
    PEER_NAME_RULE_LOAD_FAILED,
    PEER_NAME_RULE_DISABLED,
    PEER_NAME_RULE_NO_ID,
    PEER_NAME_RULE_ID_CONFLICT,
    PEER_NAME_RULE_CANT_FIND,
    PEER_NAME_RULE_PARAM_WRONG,
    PEER_NAME_RULE_URL_WRONG,
    PEER_NAME_RULE_ENABLED,
    PEER_NAME_RULE_UPDATED,
    PEER_NAME_RULE_ALL_UPDATED,
    PEER_NAME_RULE_SAVED,
    PEER_NAME_RULE_DELETED,
    PEER_NAME_RULE_INFO_QUERY_SUCCESS,
    PEER_NAME_RULE_LOG_QUERY_SUCCESS,
    PEER_NAME_RULE_LOG_QUERY_ERROR,
    PEER_NAME_RULE_LOG_QUERY_WRONG_PARAM,
    PEER_NAME_RULE_CHECK_INTERVAL_QUERY_SUCCESS,
    PEER_NAME_RULE_CHECK_INTERVAL_WRONG_PARAM,
    PEER_NAME_RULE_CHECK_INTERVAL_UPDATED,
    PEER_NAME_RULE_ENABLED_WRONG_PARAM,
    ...
    DATABASE_MIGRATION_SQLITE_VERSION,
    ...
    BACKGROUND_TASK_PRINT_ITEM_ERROR,
    BACKGROUND_TASK_NAME_UPDATE_NAT_STATUS,
    AUTOSTUN_RESTARTED,
    ...
    AUTOSTUN_DOWNLOADER_TUNNEL_UNREGISTERED,
    BTSTUN_RESTART_FAILED,
    BTSTUN_FORWARDER_CREATING,
    BTSTUN_SHUTDOWN_DOWNLOADER_OFFLINE,
    BTSTUN_SHUTDOWN_DOWNLOADER_ONLINE,
    ...
    BGTASK_TITLE_EMPTY,
    BGTASK_WEBSOCKET_TASK_NOT_FOUND,
    ...
    MODULE_ICDP_RULE_TITLE, MODULE_ICDP_RULE_DESCRIPTION,
    ...
    MODULE_PEER_ANALYSING_DELETING_EXPIRED_DATA_LOG,
    MODULE_PEER_ANALYSING_DELETED_EXPIRED_DATA,
    ...
    DBNT_MIGRATOR_ARCHIVING_LEGACY_PROGRESS, BTN_ABILITY_ALLOW_LIST_UNBAN_PEER, BTN_ABILITY_ALLOW_LIST_UNBAN_ALERT_TITLE, BTN_ABILITY_ALLOW_LIST_UNBAN_ALERT_DESCRIPTION, MODULE_IP_BLACKLIST_SUB_TURNED_OFF;
