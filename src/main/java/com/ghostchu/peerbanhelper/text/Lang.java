...
public enum Lang {
    ...
    GUI_TABBED_LOGS,
    GUI_TABBED_PEERS,
    GUI_TABBED_DASHBOARD,
    GUI_TABBED_BAN_LIST,
    GUI_TABBED_DATA,
    GUI_TABBED_DATA_BAN_LOGS,
    GUI_TABBED_DATA_TORRENT_HISTORY,
    GUI_TABBED_DATA_IP_HISTORY,
    GUI_TABBED_RULE_MANAGEMENT,
    GUI_TABBED_RULE_SUBSCRIPTION,
    GUI_TABBED_RULE_CUSTOM_SCRIPTS,
    GUI_TABBED_RULE_IP,
    GUI_TABBED_RULE_PORT,
    GUI_TABBED_RULE_ASN,
    GUI_TABBED_RULE_REGION,
    GUI_TABBED_RULE_CITY,
    GUI_TABBED_METRICS,
    GUI_TABBED_METRICS_CHARTS,
    GUI_TABBED_METRICS_RANKINGS,
    GUI_TABBED_SETTINGS,
    ABOUT_VIEW_GITHUB,
    IPDB_UPDATING,
    IPDB_UPDATE_FAILED,
    ...
    BOOT_TIME,
    ECOMODE_FAILED, JBR_REQUIRED_TITLE, JBR_REQUIRED_DESCRIPTION, LAB_EXPERIMENT_WIN32_EMPTY_WORKING_SET_TITLE, LAB_EXPERIMENT_WIN32_EMPTY_WORKING_SET_DESCRIPTION, BTN_HEARTBEAT_TITLE, BTN_HEARTBEAT_DESCRIPTION, BTN_HEARTBEAT_SUCCESS, BTN_HEARTBEAT_FAILED;
