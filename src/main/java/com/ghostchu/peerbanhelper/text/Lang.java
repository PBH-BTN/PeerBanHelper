...
public enum Lang {
    ...
    DOWNLOADER_TRANSMISSION_BLOCKLIST_UPDATE_FAILED, GUI_TRAY_TITLE,
    CRASH_MANAGER_TITLE,
    ...
    DOWNLOADER_FAILED_START_TORRENT, BTN_MQTT_CONNECTED, BTN_MQTT_RECONNECTED, BTN_MQTT_DISCONNECTED;
