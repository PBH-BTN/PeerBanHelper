...
public enum Lang {
    ...
    BTN_SUBMITTED_SWARM, DOWNLOADER_FAILED_RETRIEVE_SPEED_LIMITER, DOWNLOADER_FAILED_SET_SPEED_LIMITER, DOWNLOADER_FAILED_STOP_TORRENT, DOWNLOADER_FAILED_STOP_TORRENT, DOWNLOADER_FAILED_START_TORRENT;
