...
public enum Lang {
    ...
    DOWNLOADER_FAILED_RETRIEVE_BT_PROTOCOL_PORT, PORTMAPPER_SCANNING, PORTMAPPER_SCANNED, BTSTUN_RESTART, BTSTUN_ON_TUNNEL_CLOSE, BTSTUN_ON_TUNNEL_CREATED, BTSTUN_FORWARDER_EXCEPTION, BTSTUN_UNABLE_START, BTSTUN_MODIFY_DOWNLOADER_BT_PORT, BTSTUN_TUNNEL_CREATE_SUCCESSFULLY, BACKGROUND_TASK_NOT_FOUND, BACKGROUND_TASK_CANNOT_CANCEL, BACKGROUND_TASK_CANCEL_REQUESTED;
