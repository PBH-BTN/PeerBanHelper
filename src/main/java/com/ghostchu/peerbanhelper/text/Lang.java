...
public enum Lang {
    ...
    DBNT_MIGRATOR_ARCHIVING_LEGACY_PROGRESS, BTN_ABILITY_ALLOW_LIST_UNBAN_PEER, BTN_ABILITY_ALLOW_LIST_UNBAN_ALERT_TITLE, BTN_ABILITY_ALLOW_LIST_UNBAN_ALERT_DESCRIPTION, WEBAPI_ROUTE_NOT_EXISTS;
