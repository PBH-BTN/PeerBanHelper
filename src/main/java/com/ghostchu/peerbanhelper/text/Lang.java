...
public enum Lang {
    ...
    BOOT_TIME,
    ECOMODE_FAILED, JBR_REQUIRED_TITLE, JBR_REQUIRED_DESCRIPTION, LAB_EXPERIMENT_WIN32_EMPTY_WORKING_SET_TITLE, LAB_EXPERIMENT_WIN32_EMPTY_WORKING_SET_DESCRIPTION;
