...
public enum Lang {
    ...
    MODULE_PEER_ANALYSING_DELETED_EXPIRED_DATA, MODULE_IP_BLACK_RULE_LIST_UPDATING_RULE_TITLE, BTN_ABILITY_HEARTBEAT_SYNC_SERVER, BTN_ABILITY_ALLOW_LIST_SYNC_SERVER, BTN_ABILITY_DENY_LIST_SYNC_SERVER, BTN_ABILITY_RECONFIGURE_SYNC_SERVER, BTN_ABILITY_RULEES_SYNC_SERVER, BTN_ABILITY_SUBMIT_BANS_SYNC_SERVER, BTN_ABILITY_SUBMIT_HISTORY_SYNC_SERVER, BTN_ABILITY_SUBMIT_SWARM_SYNC_SERVER, BTN_CONFIGURE_SYNC_SERVER, IPDB_DOWNLOAD_MMDB, IPDB_DOWNLOAD_MMDB_DESCRIPTION, IPDB_DOWNLOAD_MMDB_FAILED_DESCRIPTION, EARLY_STARTING_TITLE, EARLY_STARTING_PAGE_TITLE, EARLY_STARTING_PAGE_DESCRIPTION, DBNT_MIGRATOR_ARCHIVING_LEGACY_TO, DBNT_MIGRATOR_ARCHIVING_LEGACY_PROGRESS;
