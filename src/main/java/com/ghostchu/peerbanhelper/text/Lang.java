...
public enum Lang {
    ...
    BTN_CONFIG_STATUS_EXCEPTION, MATCH_STRING_STARTS_WITH,
    DOWNLOADER_FAILED_REQUEST_TRACKER_LIST_ON_TORRENT,
    TRACKER_FAILED_TO_UPDATE_TRACKER, UTILITIES_TRACKER_REPLACED, DOWNLOADER_BIGLYBT_INCORRECT_ADAPTER_VERSION;
