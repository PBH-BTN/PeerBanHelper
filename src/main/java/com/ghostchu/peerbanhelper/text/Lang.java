...
public enum Lang {
    ...
    BACKGROUND_TASK_PRINT_ITEM_ERROR, BACKGROUND_TASK_NAME_UPDATE_NAT_STATUS, AUTOSTUN_RESTARTED, AUTOSTUN_DOWNLOADER_NOT_EXISTS, AUTOSTUN_DOWNLOADER_TUNNEL_NOT_EXISTS, AUTOSTUN_DOWNLOADER_TUNNEL_FORWARDER_NOT_EXISTS;
