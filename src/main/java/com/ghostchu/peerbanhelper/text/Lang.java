...
public enum Lang {
    ...
    PBH_PLUS_LICENSE_INVALID, PBH_PLUS_LICENSE_EXPIRED, IN_ECOMODE_DESCRIPTION, IN_ECOMODE_SHORT, DOWNLOADER_TRANSMISSION_DISCOURAGE, DOWNLOADER_QBITTORRENTEE_SHADOWBANAPI_TEST_FAILURE;
