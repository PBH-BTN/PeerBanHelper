...
public enum Lang {
    ...
    GUI_CLEAR_LOGS, GUI_QT6_WAITING_EXTRACTING, GUI_QT6_WAITING_INIT, GUI_QT6_NATIVES_MISSING, WEBUI_SECURITY_LOGIN_SUCCESS_NOTIFICATION_TITLE, WEBUI_SECURITY_LOGIN_SUCCESS_NOTIFICATION_DESCRIPTION;
