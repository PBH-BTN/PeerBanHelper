...
public enum Lang {
    ...
    DOWNLOADER_TRANSMISSION_BLOCKLIST_UPDATE_FAILED, GUI_TRAY_TITLE, CRASH_MANAGER_TITLE, CRASH_MANAGER_DESCRIPTION, CRASH_MANAGER_GUI_RELATED_TITLE, CRASH_MANAGER_GUI_RELATED_DESCRIPTION, GUI_PROGRAM_SWITCH_TO_SWT, GUI_PROGRAM_SWITCH_TO_SWING, GUI_PROGRAM_SWITCH_TO_AUTO, BTN_ABILITY_SUBMIT_TRACKED_PEERS, BTN_ABILITY_SUBMIT_TRACKED_PEERS_DESCRIPTION, BTN_SUBMITTING_TRACKED_PEERS, BTN_SUBMITTED_TRACKED_PEERS;
