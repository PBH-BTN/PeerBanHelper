export default {
  ...
  'page.settings.tab.profile.module.idleConnectionDosProtection.useGlobalBanTime': '使用全局封禁时间',
  'page.settings.tab.profile.module.idleConnectionDosProtection.maxAllowedIdleTime': '允许的最长闲置连接时间',
  ...
  'page.settings.tab.profile.module.idleConnectionDosProtection.idleSpeedThreshold.tips':
    '持续低于此速度将被视为闲置连接',
  'page.settings.tab.profile.module.idleConnectionDosProtection.minStatusChangePercentage': '状态更新最小变化百分比',
  'page.settings.tab.profile.module.idleConnectionDosProtection.minStatusChangePercentage.tips':
    '状态更新时，变化百分比低于此值时仍视为闲置',
  'page.settings.tab.profile.module.idleConnectionDosProtection.resetOnStatusChange': '状态更新时重置计时器',
