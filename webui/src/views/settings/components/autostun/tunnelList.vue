这个组件确实存在一些视觉和布局问题。我将重构它，使其更加美观、简洁且响应式更好。 ```vue
<template>
  <a-card :title="t('page.settings.tab.autostun.tunnel_info')" :bordered="false">
        ...
        <a-card size="small" hoverable>
          ...
          <div class="tunnel-header">
            <div class="tunnel-title">
              <h4>{{ item.downloader.name }}</h4>
              <a-tag size="small" class="type-tag">{{ item.downloader.type }}</a-tag>
            </div>
          ...
          <div class="tunnel-stats">
            ...
            <div class="stats-row">
              ...
              <div class="stat-item">
                ...
                <div class="stat-value">{{ formatFileSize(item.tunnel.totalToUpstreamBytes) }}</div>
              </div>
            </div>
          </div>
