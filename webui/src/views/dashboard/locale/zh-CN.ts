export default {
  ...
  'page.dashboard.clientStatus.card.status.peerNumber': '已连接的 Peers',
  ...
  'page.dashboard.statics.banPeer': '封禁 Peer',
  'page.dashboard.statics.unbanPeer': '解除封禁',
  'page.dashboard.statics.currentBan': '当前处于封禁状态 Peer',
  'page.dashboard.statics.currentBanIps': '正处于封禁的 IP 数量',
  ...
  'page.dashboard.editModal.label.endpoint.error.invalidUrl': '无效的 URL',
  ...
  'page.dashboard.editModal.label.httpVersion.description': '2.0 性能更好，1.1 兼容性更好',
  'page.dashboard.editModal.label.incrementBan': '增量封禁',
  'page.dashboard.editModal.label.incrementBan.description':
    '有助于缓解保存封禁列表时的下载器压力，但在部分下载器上可能会导致无法封禁 Peers',
  ...
  'page.dashboard.editModal.label.verifySsl': '验证 SSL 证书',
