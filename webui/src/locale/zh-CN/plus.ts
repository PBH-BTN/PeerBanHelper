export default {
  ...
  'plus.status.activated.local': '已激活',
  'plus.status.status.NOT_STARTED': '未生效',
  'plus.status.status.EXPIRED': '已过期',
  'plus.status.status.INVALID': '无效',
  'plus.status.status.REVOKED': '已被撤销',
  ...
  'plug.begging.local':
    'PeerBanHelper 是一个非营利，开放源代码的免费软件。免费许可证授权这台计算机的个人用途，您不得重新出售或者用于违反服务条款的用途。如果 PeerBanHelper 帮助到了你，请考虑在面包多上捐赠支持我们：',
