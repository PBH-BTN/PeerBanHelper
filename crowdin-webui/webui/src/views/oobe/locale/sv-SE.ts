export default {
  ...
  'page.oobe.welcome.description': "PeerBanHelper is a tool for anti-leech. PBH will connect to your downloader and check if any bad peers connected to your downloader. Once any bad peer was found, PBH will ban it. Before we start, let's do some simple config first.",
  'page.oobe.setToken.title': 'Set Token',
  'page.oobe.setToken.description': 'First, you need to set a token, this token can prevent your WebUI from malicious access and protect your privacy. Once you login to your WebUI once, your browser will remember it and automaticlly login in future.',
  'page.oobe.setToken.generate': 'Generate',
  'page.oobe.addDownloader.title': 'Add your first downloader',
  'page.oobe.addDownloader.description': "Choose your downloader type first, then fill in the downloader's WebUI related authentication information.",
  ...
  'page.oobe.result.description': 'You have completed the initialization, now you can start using PeerBanHelper!',
