export default {
  ...
  'page.dashboard.editModal.label.incrementBan.description': "有助于缓解保存封禁列表时的下载器压力，但在部分下载器上可能会导致无法封禁Peers",
  'page.dashboard.editModal.label.shadowBan': 'ShadowBan',
  'page.dashboard.editModal.label.shadowBan.description': "使用 qBittorrent Enhanced Edition 提供的 ShadowBan API 来代替传统 IP 屏蔽列表。{learnMore}",
  ...
  'page.dashboard.editModal.transmission.discourage': "警告：Transmission 适配器已被废弃，并将在将来的版本移除。https://github.com/PBH-BTN/PeerBanHelper/issues/382",
