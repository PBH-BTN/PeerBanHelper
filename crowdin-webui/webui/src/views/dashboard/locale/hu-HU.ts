export default {
  ...
  'page.dashboard.editModal.label.endpoint.error.invalidSchema': 'Must start with http:// or https://',
  ...
  'page.dashboard.editModal.label.httpVersion.description': '2.0 is faster, which 1.1 is more compatible',
  'page.dashboard.editModal.label.incrementBan': 'Incremental Ban',
  'page.dashboard.editModal.label.incrementBan.description': 'Helps to alleviate the downloader pressure when saving the ban list, but may cause the inability to ban Peers on some downloaders',
  'page.dashboard.editModal.label.shadowBan': 'ShadowBan',
  'page.dashboard.editModal.label.shadowBan.description': "Use qBittorrent Enhanced Edition's ShadowBan API to replace the regular IP block list. {learnMore}",
  ...
  'page.dashboard.editModal.transmission.discourage': 'Warning: Support for Transmission is deprecated, support will be removed in the future. https://github.com/PBH-BTN/PeerBanHelper/issues/382',
  ...
  'page.dashboard.peerList.column.flags.d': "Your client wants to download, but peer doesn't want to send (interested and choked)",
  'page.dashboard.peerList.column.flags.U': 'Currently uploading (interested and not choked)',
  'page.dashboard.peerList.column.flags.u': "Peer wants your client to upload, but your client doesn't want to (interested and choked)",
  ...
  'page.dashboard.peerList.column.flags.K': 'Peer is unchoking your client, but your client is not interested',
  'page.dashboard.peerList.column.flags.?': 'Your client unchoked the peer but the peer is not interested',
  'page.dashboard.peerList.column.flags.X': 'Peer was included in peerlists obtained through Peer Exchange (PEX)',
  ...
  'page.dashboard.peerList.column.flags.L': 'Peer is local (discovered through network broadcast, or in reserved local IP ranges)'
};